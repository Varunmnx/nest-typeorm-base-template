...
// import { CookiesKeys, VerifyAuthRequest } from '../../auth/dto/verify-auth.dto';
...
//             'canActivate => ' + className + '.' + methodKey + '[headers]',
...
//     let authorization =  request['cookies'][CookiesKeys.TOKEN]; 
//     console.log(request['cookies'][CookiesKeys.TOKEN] ) 
//     if (authorization) {
...
//     const authInfo = new AuthInfo(authorization, verifyAuthResponse.userId, verifyAuthResponse.role, verifyAuthResponse.isEmailVerified);
...
//     AuthGuard._set(request, 'body', AuthInfo.ROLE_KEY, authInfo.role);
//     AuthGuard._set(request, 'body', AuthInfo.IS_EMAIL_VERIFIED, authInfo.isEmailVerified);
...
//     AuthGuard._set(request, 'query', AuthInfo.ROLE_KEY, authInfo.role);
//     AuthGuard._set(request, 'query', AuthInfo.IS_EMAIL_VERIFIED, authInfo.isEmailVerified);
...
//     AuthGuard._set(request, 'params', AuthInfo.ROLE_KEY, authInfo.role);
//     AuthGuard._set(request, 'params', AuthInfo.IS_EMAIL_VERIFIED, authInfo.isEmailVerified);
//     return true;
//   }
