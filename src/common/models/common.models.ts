...
export class KeyValuePair<K, V> {
  private constructor(public key: K, public value: V, public message?: string) {}

  public static of<K, V>(key: K, value: V, isMessageRequired = false) {
...
export class RepoPagination<T> {
  public readonly page: number;
  public readonly limit: number;
  public readonly skip: number;
  public readonly sort: FindOptionsOrder<T>;

  private constructor(page: number, skip: number, limit: number, sort: FindOptionsOrder<T>) {
